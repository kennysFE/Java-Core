...
public class MainLab09 {
	...
	public static int checkAgeSinhVien(int ageSinhVien) throws ExceptionCheckAge {
		if (ageSinhVien <= 100 || ageSinhVien >= 1000) {
			throw new ExceptionCheckAge(ageSinhVien);
		}
		return ageSinhVien;
	}
	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			try {
				...
				// C1 : Tao ham xu ly try catch ()
				try {
					checkAgeSinhVien(ageSinhVien);
					break;
				} catch (ExceptionCheckAge e) {
					// TODO: handle exception
					System.out.println(e.getMessage());
				}

				// C2 : Thuc hien Try catch xu ly ben trong 1 Try catch khac
